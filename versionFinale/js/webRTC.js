...
function WebRTC() {
    ...
    var peerMedia = new Array(); // tableau de connexion dédié au stream
    var iceServers = [];
    ...
    var cptAnswer = 0; // compteur incrémenté uniquement lorsqu'on reçoit un data de type Answer
    var cptConnexion = 0; // compteur de connexion
    var cptReceiveChannel = 0; // compteur incrémenté uniquement lorsqu'on reçoit un channel
    ...
    var myStream = false;
    var otherStream = new Array(); // tableau de flux streaming
     ...
     * ==================================
     */
    var sendDataPrivate = function(data) {
        var i = 0;
        ...
        try {
            ...
            switch (event.data) {
                ...
                case "u":
                    ...
                    break;
                default:
                    console.log("It's not a mouvement command");
    ...
    var takeMedia = function(param, success) {
        ...
        navigator.getMedia = (navigator.getUserMedia ||
                navigator.webkitGetUserMedia || // les fonctions préfixées par webkit sont utilisées par google chrome
